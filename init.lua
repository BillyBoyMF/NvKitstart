...
function NvConfig:InitWhichKeyBarbarMappings()
	require("which-key").add({
		...
		{ "<leader>bol", "<cmd>BufferOrderByLanguage<cr>", desc = "Order by language", mode = "ni", group = "barbar" },
		{
			"<leader>bow",
